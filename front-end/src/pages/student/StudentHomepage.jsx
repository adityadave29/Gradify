    ...
    <div className="min-h-screen bg-zinc-950 px-4 py-10 text-zinc-100">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-semibold tracking-tight">Welcome, {user?.email?.split('@')[0] || 'Student'}</h1>
          <p className="mt-2 text-sm text-zinc-400">Manage your course enrollments and grades.</p>
        </div>
